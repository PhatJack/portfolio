	...
	return (
		<div className="size-full flex flex-col gap-2 justify-center items-center">
			...
			<div className="size-full flex justify-center items-center">
				<iframe height="161px" width="780px" src="https://git-graph.vercel.app/embed/PhatJack?showColorLegend=true&showWeekdayLabels=false&showMonthLabels=true&showTotalCount=true&blockMargin=2&blockRadius=2&blockSize=12&fontSize=14&weekStart=6&year=2024"></iframe>
			</div>
		</div>
	)
}
